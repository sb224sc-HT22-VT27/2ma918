...
if __name__ == "__main__":
    ...
    print(f"because it uses second-order information (Hessian) and converges")
    print(f"in a single iteration for quadratic functions when starting close enough.")
