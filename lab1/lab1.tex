...
\begin{equation}
c = \begin{bmatrix} 700 \\ 1000 \end{bmatrix}, \quad
A = \begin{bmatrix} 3 & 5 \\ 1 & 3 \\ 2 & 2 \end{bmatrix}, \quad
b = \begin{bmatrix} 3900 \\ 2100 \\ 2200 \end{bmatrix}
\end{equation}
...
\begin{figure}[h]
    ...
    \caption{Feasible region for the TV production problem}
...
\begin{figure}[h]
    ...
    \caption{Feasible region with level curves of the objective function}
...
\begin{figure}[h]
    ...
    \caption{Performance comparison: Simplex vs HiGHS method}
